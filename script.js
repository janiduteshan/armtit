...
document.addEventListener("DOMContentLoaded", function () {
  ...
  markers.forEach((marker) => {
    ...
    marker.addEventListener("markerFound", function () {
      if (config.debugMode)
        console.log(`AR Detection: ${objectName} marker identified`);
    ...
    marker.addEventListener("markerLost", function () {
      if (config.debugMode)
        console.log(`AR Detection: ${objectName} marker lost`);
      hideObjectInfo();
    });
  });
  ...
  function getObjectDescription(objectName) {
    const descriptions = {
      ...
      chair:
        "Classroom Chair: Ergonomic seating designed for proper posture during learning sessions",
      blackboard:
        "Blackboard: Traditional visual communication tool for educational content delivery",
      bookshelf:
        "Bookshelf: Storage system for educational resources and reference materials",
      globe:
        "World Globe: Three-dimensional geographical representation for spatial learning",
    };
